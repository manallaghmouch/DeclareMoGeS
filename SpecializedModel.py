...
class SpecializedModel: 
    ...
    def __init__(self, filename, initial_model, specialization_percentage = 1, subset_to_keep = []):
        self.constraint_list = self.specialise_model(filename, initial_model, specialization_percentage, subset_to_keep)
    ...
    def specialise_model(self, filename, initial_model, specialization_percentage, subset_to_keep): # user can indicate to keep a part of the initial model in the specialized model
